...
# CD CFG
CFG.CD = CN()
CFG.CD.POPULATION_SIZE = 10
CFG.CD.SAMPLES_PER_EPOCH = 100
CFG.CD.LR = 0.01
CFG.CD.EPOCHS = 2000
CFG.CD.SCHEDULE = [500,1000,1500] 
CFG.CD.USE_DATASET = False
CFG.CD.USE_ADV = True
CFG.CD.RANDOM_INIT = False
CFG.CD.WINDOW = 20000
CFG.CD.IMAGES_PER_EPOCH = 2000
CFG.CD.USE_LABELS = False
CFG.CD.PROB = 1.0