...
ck=torch.load("rank40_trackgood_traj.pt",map_location=dev,weights_only=False)  # CONTINUE from it10000
...
for it in range(1,30001):
    ...
    if it%500==0:
        ...
        torch.save({"p":p.cpu(),"Brec":Brec.cpu(),"b1r":b1r.cpu()},"rank40_trackgood2_traj.pt")
